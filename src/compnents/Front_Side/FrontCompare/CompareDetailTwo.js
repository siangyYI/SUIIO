        ...
        <div className="mx-auto ">
          <div className="row">
            <div className="stext d-flex">
              <div className="size2 d-flex justify-content-start">
                收入
              </div>

              <div className="ml-3 " style={{ color: "rgb(69, 185, 69)" }}>
                {Number(
                  parseFloat(Math.abs(accounts1.income)).toFixed(3)
                ).toLocaleString("en", {
            ...
            <div className=" col stext d-flex">
              ...
              <div className="ml-3 " style={{ color: "rgb(196, 68, 68)" }}>
                {Number(
                  parseFloat(Math.abs(accounts1.cost)).toFixed(3)
                ).toLocaleString("en", {
                  minimumFractionDigits: 0,
                })}
              </div>
          ...
          <div className="comparetext d-flex"  style={{marginLeft:"15%"}}>
            {account[2] > 0 ? (
              <>
